...
marketing-shell: ## Run a shell on the marketing site container
	sudo docker exec -it edx.devstack.marketing env TERM=$(TERM) bash

stop-marketing:   ## Stop all services (including the marketing site) with host volumes
	sudo docker-compose -f docker-compose.yml -f docker-compose-host.yml -f docker-compose-marketing-site.yml -f docker-compose-marketing-site-host.yml stop

down-marketing:   ## Bring down all services (including the marketing site) with host volumes
	sudo docker-compose -f docker-compose.yml -f docker-compose-host.yml -f docker-compose-marketing-site.yml -f docker-compose-marketing-site-host.yml down

up-marketing:   ## Bring up all services (including the marketing site) with host volumes
	sudo docker-compose -f docker-compose.yml -f docker-compose-host.yml -f docker-compose-marketing-site.yml -f docker-compose-marketing-site-host.yml up

up-marketing-detached:   ## Bring up all services (including the marketing site) with host volumes (in detached mode)
	sudo docker-compose -f docker-compose.yml -f docker-compose-host.yml -f docker-compose-marketing-site.yml -f docker-compose-marketing-site-host.yml up -d
